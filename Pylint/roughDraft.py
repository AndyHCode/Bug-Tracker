...
def storage(name, description, date, priority, position):
    ...
    keys = name + str(random.randint(0, 100)) + \
        str(len(storage) + 1) + str(random.randint(1, 9))
...
def get_specific_key(name, description, date, priority, position):
